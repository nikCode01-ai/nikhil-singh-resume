...
export const projectSlugs: ProjectSlug[] = [
  ...
  },
  {
    ...
    category: "repository",
    tags: ["Full Stack", "Lead Management", "Booking System", "API Integration"],
    ...
    image: "/images/freshkosher.png",
    date: "2023",
    tech: ["Node.js", "Express", "MongoDB", "React", "Google Apps Script", "Mattermost API", "REST APIs"],
    features: [
  ...
  },
  {
    ...
    category: "website-design",
    tags: ["Landing Pages", "Event Management", "Responsive Design", "Frontend"],
    ...
    date: "2023",
    tech: ["HTML", "CSS", "JavaScript", "Bootstrap 5", "jQuery", "PHP", "MySQL"],
    features: [
  ...
  },
  {
    ...
    date: "2023",
    tech: ["HTML", "CSS", "JavaScript", "React", "Framer Motion", "Tailwind CSS", "Node.js"],
    features: [
  ...
  },
  {
    ...
    longDescription: "MuffleIt is a comprehensive web platform built with full-stack capabilities. The project involved developing both frontend interfaces and backend systems to create a seamless user experience. Features include user authentication, data management, API integrations, and real-time updates.",
    image: "/images/muffleit.png",
    date: "2023",
    tech: ["React", "Node.js", "Express", "MongoDB", "WebSockets", "REST APIs", "JWT Auth"],
    features: [
      "User authentication",
      "Real-time updates",
      "Data visualization",
    ...
    teamSize: "2 developers",
    role: "Full Stack Developer",
    methodologies: ["Agile", "Full Stack Development", "Test-Driven Development"],
    challenges: [
  ...
  },
  {
    ...
    longDescription: "A content-focused website for Barry McGuigan, featuring optimized performance, excellent SEO structure, and a clean, professional design. The site showcases content, media, and information while maintaining fast load times and great user experience across all devices.",
    image: "/images/barrymcguigan.png",
    date: "2023",
    tech: ["HTML", "CSS", "JavaScript", "Next.js", "Tailwind CSS", "SEO Tools", "Performance Optimization"],
    features: [
  ...
  },
  {
    ...
    longDescription: "Business Matters is a comprehensive content platform developed to deliver articles, news, and business insights efficiently. The project involved building a robust content management system, optimizing performance, and ensuring seamless content delivery to users across various devices.",
    image: "/images/businessmatters.png",
    date: "2023",
    tech: ["Next.js", "React", "Node.js", "MongoDB", "Redis", "CMS", "REST APIs"],
    features: [
      "Content management",
      "Article publishing",
  ...
  },
  {
    ...
    longDescription: "A professional business website for Agrosaf Pharmaceuticals, featuring product catalogs, company information, and integrated backend services. The platform includes customer management, order processing, and integration with various business systems to streamline operations.",
    image: "/images/agrosafpharmaceuticals.png",
    date: "2023",
    tech: ["React", "Node.js", "Express", "MongoDB", "Payment Gateway", "Email Services", "Admin Dashboard"],
    features: [
      "Product catalog",
      "Company information",
      "Customer management",
  ...
  },
  {
    ...
    longDescription: "A modern, responsive business website for Lala Decorators showcasing their decoration and event services. The site features an elegant design, gallery of work, service descriptions, and contact forms to help customers connect and learn about their offerings.",
    image: "/images/laladecorators.png",
    date: "2023",
    tech: ["HTML", "CSS", "JavaScript", "React", "Tailwind CSS", "Image Optimization", "Contact Forms"],
    features: [
      "Responsive design",
      "Service showcase",
      "Image gallery",
  ...
  },
  {
    ...
    longDescription: "Ultimate Sports Trainer is a comprehensive web platform for sports training and fitness programs. The platform includes user management, workout tracking, progress monitoring, and various features to help users achieve their fitness goals. Involved both frontend enhancements and backend development.",
    image: "/images/ultimatesportstrainer.png",
    date: "2023",
    tech: ["React", "Node.js", "Express", "MongoDB", "Chart.js", "Video Streaming", "REST APIs"],
    features: [
      "User authentication",
      "Workout programs",
      "Progress tracking",

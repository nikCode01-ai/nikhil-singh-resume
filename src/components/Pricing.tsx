...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        label: 'Architecture + DB optimization (Postgres/Mongo)',
        enabled: true,
      },
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-3xl text-sm leading-6 text-white/70">
                  Pricing is based on real delivery across Next.js platforms,
                  real-time systems (WebSockets/SSE), and airline NDC
                  integrations.
                </p>
              </div>
              <ButtonLink

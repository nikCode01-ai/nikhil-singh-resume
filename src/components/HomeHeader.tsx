      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-3">
        ...
        >
          <div className="flex items-center justify-between gap-4 px-4 sm:px-6 py-3">
            ...
            <nav
              className="hidden items-center gap-0.5 xl:gap-1 text-xs xl:text-sm font-medium text-slate-600 dark:text-slate-300 lg:flex"
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      'relative px-2 py-1.5 xl:px-3 xl:py-2 rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-950 whitespace-nowrap',
                      active
                  ...
                  >
                    ...
                    {active && (
                      <span
                        className="absolute bottom-0.5 left-2 right-2 xl:left-3 xl:right-3 h-0.5 rounded-full bg-brand-green dark:bg-emerald-400"
                        aria-hidden="true"
                      />
                    )}
                  </Link>
